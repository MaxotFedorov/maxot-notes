"""
Django settings for maxot_notes project.
...
SECRET_KEY = os.environ.get("SECRET_KEY", "the_secret")
...
WSGI_APPLICATION = 'maxot_notes.wsgi.application'
